...
const D={spotify:{clientId:"",clientSecret:"",accessToken:null,refreshToken:null},ui:{colors:{titleColor:"#ffffff",artistColor:"rgba(255,255,255,0.74)",vizColor:"#ffffff",accent:"#1DB954",background:"rgba(255,255,255,0.05)",textSecondary:"rgba(255,255,255,0.70)"},rainbow:{enabled:false,mode:"static"},showCover:true,showTitle:true,showArtist:true,showAlbum:true,showProgress:true,showVisualizer:true,vizStyle:"spiky",visualizerSensitivity:1.0,visualizerBars:180},audio:{source:"voicemeeter",customDeviceId:null,desktopSourceId:null},behavior:{volumeOpacity:true,volumeOpacityMin:0.22,volumeOpacityMax:0.88,fadeDelay:3000,alwaysOnTop:true,developerMode:false},update:{url:"",autoCheck:true}};
let s=null;
function dm(t,src){const r={...t};for(const k of Object.keys(src)){const v=src[k];if(v===null||v===undefined)continue;if(typeof v==="object"&&!Array.isArray(v))r[k]=dm(t[k]||{},v);else r[k]=v}return r}
